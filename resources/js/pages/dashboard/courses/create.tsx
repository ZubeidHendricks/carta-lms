...
const Index = (props: Props) => {
   ...
   const { labels, prices, expiries, categories, instructors, system, currentInstructorId } = props;
   ...
   const { data, setData, post, errors, processing } = useForm({
      ...
      thumbnail: null,
      instructor_id: user.role === 'admin' && system.sub_type === 'collaborative' ? '' : (currentInstructorId || ''),
      course_category_id: '',
