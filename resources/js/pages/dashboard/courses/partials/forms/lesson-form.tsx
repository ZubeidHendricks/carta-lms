...
const getLessonTypes = (translate: any) => [
   ...
   { value: 'tavus', label: 'Tavus AI Video', flag: false },
...
const LessonForm = ({ title, handler, lesson, sectionId }: Props) => {
   ...
   const { data, setData, post, put, reset, processing, errors, clearErrors } = useForm({
      ...
      tavus_conversation_id: lesson ? lesson.tavus_conversation_id : '',
      tavus_replica_id: lesson ? lesson.tavus_replica_id : '',
      tavus_api_key: lesson ? lesson.tavus_api_key : '',
                           ...
                           <>
                              <div>
                                 ...
                                 <Input
                                    ...
                                    value={data.tavus_conversation_id || ''}
                                    placeholder="Enter Tavus conversation ID"
                                    onChange={(e) => onHandleChange(e, setData)}
                                 />
                                 <InputError message={errors.tavus_conversation_id} />
                              </div>

                              <div>
                                 <Label>
                                    Tavus Replica ID
                                    <span className="text-xs text-gray-500"> (Optional, used if no conversation ID)</span>
                                 </Label>
                                 <Input
                                    name="tavus_replica_id"
                                    value={data.tavus_replica_id || ''}
                                    placeholder="Enter Tavus replica ID"
                                    onChange={(e) => onHandleChange(e, setData)}
                                 />
                                 <InputError message={errors.tavus_replica_id} />
                              </div>
                              ...
                              <div>
                                 ...
                                 <Input
                                    required
                                    name="tavus_api_key"
                                    value={data.tavus_api_key || ''}
                                    placeholder="Enter Tavus API key"
                                    onChange={(e) => onHandleChange(e, setData)}
                                 />
                                 <InputError message={errors.tavus_api_key} />
                              </div>
                           </>
                        )}
