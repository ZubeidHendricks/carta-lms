...
import { Award, Book, Briefcase, CassetteTape, CreditCard, LayoutDashboard, Newspaper, Receipt, School, Settings, Users, Trophy, Target, Bot, Medal } from 'lucide-react';
      ...
      pages: [
         {
            ...
            active: true,
            access: ['admin', 'instructor', 'student', 'collaborative', 'administrative'],
            children: [],
         },
      ],
   },
      ...
      pages: [
         {
            ...
            slug: 'progress',
            active: true,
            access: ['student', 'collaborative', 'administrative'],
            children: [],
         },
         {
            Icon: Award,
