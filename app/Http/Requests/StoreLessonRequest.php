...
class StoreLessonRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'lesson_type' => 'required|string|in:video_url,video,document,image,text,embed,tavus',
            ...
            'tavus_conversation_id' => 'nullable|string|max:255',
            'tavus_replica_id' => 'nullable|string|max:255',
            'tavus_api_key' => 'nullable|string',
            'embed_source' => [
                'nullable',
                'string',
        ...
        switch (request('lesson_type')) {
            case 'video_url':
                ...
                break;
            case 'tavus':
                $rules['tavus_api_key'] = 'required|string';
                break;
        }
